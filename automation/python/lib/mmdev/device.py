...
def details(function):
    collection = 'BUILTIN'
    name = (
        suppress(lambda: function.__class__.name)
...
class Device:
    def __init__(self, room_name, device_class, device_name, item_base=None, tracing=None):
    ...
    def property(self, property_type, property_name, channel=None, default=None, force=False, normalize=False, metadata=None, groups=None, dimension=None, tracing=None):
        if tracing is None:
            tracing = self.__tracer
